  ...
  <div class="row">
    <div class ="col-md-8 col-xs-12">
      ...
      <div class="clearfix"></div>
        <?php echo form_open('Ricerche/esegui_ricerca_tutto', array('class' => 'form-horizontal form-label-left')); ?>
      <div class="x_panel">
        <div class="x_content">    
          <div class = "row">
          ...
          <div class="row">
            ...
            <div class ="col-md-6 col-xs-12">                 
              ...
              <?php echo anchor('Ricerche/ricerca_tutto', 'Clear', array('class' => 'btn btn-primary pull-right')); ?>
