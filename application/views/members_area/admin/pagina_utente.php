	      ...
	      <div class="x_panel">
        	<div class="x_content">
              ...
              <div class="col-md-9 col-sm-9 col-xs-12">                   
								<?php echo form_input(array('type' => 'text', 'class'=>'form-control', 'placeholder'=> $dati_utente[0]->nome, 'id' => 'nome', 'name' => 'nome', 'value' => $dati_utente[0]->nome)); set_value('nome', $dati_utente[0]->nome); ?>
              </div>
            </div>
          	<div class="form-group">
          	<?php echo form_label('Cognome', 'cognome', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
              <div class="col-md-9 col-sm-9 col-xs-12">                   
								<?php echo form_input(array('type' => 'text', 'class'=>'form-control', 'placeholder'=> $dati_utente[0]->cognome, 'id' => 'cognome', 'name' => 'cognome', 'value' => $dati_utente[0]->cognome)); set_value('cognome', $dati_utente[0]->cognome); ?>
              </div>
            </div>
	          <div class="form-group">
	          ...
	          <div class="form-group">
	            ...
	            <div class="col-md-9 col-sm-9 col-xs-12">                   
								<?php echo form_input(array('type' => 'text', 'class'=>'form-control', 'placeholder'=> $dati_utente[0]->email, 'id' => 'email', 'name' => 'email', 'value' => $dati_utente[0]->email)); set_value('email', $dati_utente[0]->email); ?>
	            </div>
	          </div>
          	<div class="form-group">
          		<?php echo form_label('Username', 'username', array('class' => 'control-label col-md-3 col-sm-3 col-xs-12')); ?>
              <div class="col-md-9 col-sm-9 col-xs-12">                   
								<?php echo form_input(array('type' => 'text', 'class'=>'form-control', 'placeholder'=> $dati_utente[0]->username, 'id' => 'username', 'name' => 'username', 'value' => $dati_utente[0]->username)); set_value('username', $dati_utente[0]->username); ?>
              </div>     
